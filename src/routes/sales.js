...
// Sale item price editing
router.put('/:id/item/:item_id/price', SalesController.updateItemPrice);
router.get('/:id/item/:item_id/price-history', SalesController.getItemPriceHistory);
